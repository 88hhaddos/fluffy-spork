...
DEFAULT_TRIGGERS = [
    ...
    "дракоша", "драк", "закурий", "бот", "тлею", "тлеющий",
]
...
def _filter_ai_thoughts(text: str) -> str:
    ...
    LEAK_PHRASES = [
        ...
        "this means", "could mean", "this could mean",
        "would be", "reversed:", "backwards:",
        "not use the word", "not say",
        "it could mean", "so the format",
        "wait, that says", "let me re-read",
        "so france", "so germany", "so netherlands",
        "so argentina", "so brazil", "so england",
        "so spain", "so portugal", "so mexico",
        "so norway", "so japan", "so morocco",
        ...
        "grafs is asking", "vitaly is asking",
    ]
...
async def _generate_and_send_response(
    ...
    try:
        ...
        THREAT_WORDS = [
            ...
            "удаляет", "удалит", "навсегда", "с чата", "напишу дрейку", "напишу создателю",
            "пишу твоему создателю", "даю тебе минуту", "даю ровно", "извинения или",
            "на извинения", "за маты", "за оскорбление", "наезд", "угрожаю",
            "я тебя удалю", "я тебя забаню", "сейчас удалю", "прямо сейчас",
            "тебя с чата", "за мат", "пиши создателю", "удалит тебя",
            "прикажу удалить", "прикажу забанить", "счас забаню", "счас удалю",
            "даю 1 минуту", "даю минуту", "у тебя минута", "у тебя 1 минута",
        ]
